...
// // I don't understand why any name makes the function work. 
// // I understand the etiquette of having a plural name for an array or object so you can refer to parts singularly (ie gyms to gym). But the explanations say it can be changed to any name (next example I tried another word), so how does this work??

// game.gyms.forEach (room =>  {
